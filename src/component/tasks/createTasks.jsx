...
import { addTask } from "../../store/dailyTasks/taskSlice";
import styles from "./CreateTasks.module.css";
const CreateTasks = ({ setAddPage }) => {
  const { isError } = useSelector((state) => state.tasks);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      priority: "---",
      status: "---",
      taskDescription: "No Work assigned",
      employeeId: user._id,
    },
    ...
    <Container>
      <Box>
        <form onSubmit={formik.handleSubmit}>
          ...
          {/* ------------selector container -------------- */}
          <Grid container className={styles.selectorContainer}>
            {/* ------------category input -------------- */}
